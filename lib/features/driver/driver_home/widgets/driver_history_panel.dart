...
class DriverHistoryPanel extends StatefulWidget {
  const DriverHistoryPanel({super.key});

  @override
  State<DriverHistoryPanel> createState() => _DriverHistoryPanelState();
}

class _DriverHistoryPanelState extends State<DriverHistoryPanel> {
