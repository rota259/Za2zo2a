...
class _FindingDriverViewState extends State<FindingDriverView> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // After 4 seconds, fake finding a driver and navigate to active trip
    Future.delayed(const Duration(seconds: 4), () {
      if (mounted) {
        context.pushReplacement('/home/active-trip');
      }
    });
  }
            ...
            Padding(
              ...
              child: Align(
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    context.pop(); // Go back to ride selection
                  },
                ),
              ),
            ),
